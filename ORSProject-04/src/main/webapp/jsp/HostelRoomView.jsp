		...
		<div align="center">
			...
			<table>
				...
				<tr>
					...
					<td style="position: fixed;">
						<font color="red">
							<%=ServletUtility.getErrorMessage("roomType", request)%>
						</font>
					</td>
				</tr>
				...
				<tr>
					...
					<td style="position: fixed;">
						<font color="red">
							<%=ServletUtility.getErrorMessage("rent", request)%>
						</font>
					</td>
				</tr>
				...
				<tr>
					...
					<td align="left" colspan="2">
						<input type="submit" name="operation"
							value="<%=HostelRoomCtl.OP_UPDATE%>">
						<input type="submit" name="operation"
							value="<%=HostelRoomCtl.OP_CANCEL%>">
					</td>
					<%
						} else {
					%>
					<td align="left" colspan="2">
						<input type="submit" name="operation"
							value="<%=HostelRoomCtl.OP_SAVE%>">
						<input type="submit" name="operation"
							value="<%=HostelRoomCtl.OP_RESET%>">
					</td>
					<%
						}
					%>
