...
<%@page import="in.co.rays.proj4.controller.HostelRoomListCtl"%>
<%@page import="in.co.rays.proj4.util.ServletUtility"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>
<%@page import="in.co.rays.proj4.bean.HostelRoomBean"%>
...
<body>
	...
	<div align="center">
		...
		<form action="<%=ORSView.HOSTEL_ROOM_LIST_CTL%>" method="post">
