...
/**
 * Utility class that provides various data validation methods 
 * used throughout the application such as checking null, numbers, 
 * email format, names, roll numbers, password strength, phone numbers 
